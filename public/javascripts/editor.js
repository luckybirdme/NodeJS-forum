...
function addImageToPost(editor){
  ...
  var cm = editor.codemirror;
  var stat = getState(cm);
  _replaceSelection(cm, stat.image, '!['+imageName, ']('+imageUrl+')');
...
function togglePreview(editor) {
  ...
  var wrapper = document.getElementById("editor-preview-container");
  var preview = wrapper.lastChild;  

  if (preview == null || !/editor-preview/.test(preview.className)) {
...
Editor.prototype.render = function(el) {
  ...
  this.togglePreview();
  // 添加图片
  $("#addToPostButton").click(function(){
    addImageToPost(self);
  });
...
Editor.prototype.inputCode = function() {
  inputCode(this);
};
